...
public class JwtConfiguration {
    // this method specifies the private and public endpoints
    @Autowired
    JwtFilter jwtFilter;
        ...
        return http.csrf(c -> c.disable())
                ...
                .authorizeHttpRequests(
                        auth -> auth.requestMatchers(
                                ...
                                ).permitAll()       // the public endpoints mentioned above are accessible to everybody
                                .anyRequest().authenticated() // all others will be authenticated
                )
